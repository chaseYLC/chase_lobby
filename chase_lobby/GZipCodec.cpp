...
bool GZipCodec::CompressToBuffer(const std::string& data, unsigned char * outBuffer, unsigned short &outSize, int level)
{
	unsigned char *currentPtr = outBuffer;
	outSize = 0;
